        ...
        plugins: [
            ...
            [
                '@sentry/react-native/expo',
                {
                    ...
                    enabled: true,
                    autoUpload: !!(process.env.SENTRY_AUTH_TOKEN && process.env.SENTRY_AUTH_TOKEN.length > 1),
                    autoUploadSourceMaps: !!(process.env.SENTRY_AUTH_TOKEN && process.env.SENTRY_AUTH_TOKEN.length > 1),
                    autoUploadProguardMapping: !!(process.env.SENTRY_AUTH_TOKEN && process.env.SENTRY_AUTH_TOKEN.length > 1),
                },
            ],
            'expo-localization',
