    ...
    const handleNext = () => {
        ...
        if (!Number.isFinite(spend) || spend <= 0) {
            showConfirmationModal({
                ...
                message: 'Estimated expenditure must be greater than 0 to continue.',
                confirmText: 'OK',
                onConfirm: () => {},
            });
            return;
        ...
        // for very low values (< 1) ask for confirmation but still allow continuing
        if (spend < 10) {
            showConfirmationModal({
                title: 'Is this correct?',
                message:
                    'Your estimated expenditure is very low. Do you want to continue with this amount?',
    ...
    return (
        ...
        >
            ...
            >
                ...
                <View className='flex-col flex-1 justify-between px-5'>
                    ...
                    <View className='items-center self-center justify-center w-full -bottom-5 absolute'>
